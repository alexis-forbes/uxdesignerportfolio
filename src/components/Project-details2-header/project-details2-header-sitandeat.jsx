...
const ProjectDetails2HeaderSitAndEat = ({ projectHeaderDataSitAndEat }) => {
    return (
        <section
            className="page-header proj-det bg-img parallaxie valign"
            style={{ backgroundImage: `url(${projectHeaderDataSitAndEat.projectHeaderImage})` }}
            data-overlay-dark="4"
        >
            {/*
...
export default ProjectDetails2HeaderSitAndEat;

...
const ProjectDetails2HeaderLiveHelp = ({ projectHeaderDataLiveHelp }) => {
    return (
        <section
            className="page-header proj-det bg-img parallaxie valign"
            style={{ backgroundImage: `url(${projectHeaderDataLiveHelp.projectHeaderImage})` }}
            data-overlay-dark="4"
        >
            {/*
...
export default ProjectDetails2HeaderLiveHelp;

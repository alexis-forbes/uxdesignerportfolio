...
const ProjectDetails2HeaderCinemaz = ({ projectHeaderDataCinemaz }) => {
    return (
        <section
            className="page-header proj-det bg-img parallaxie valign"
            style={{ backgroundImage: `url(${projectHeaderDataCinemaz.projectHeaderImage})` }}
            data-overlay-dark="4"
        >
            {/*
...
export default ProjectDetails2HeaderCinemaz;
